...
/** Android platform implementation of the CachedVideoPlayerPlugin. */
public class CachedVideoPlayerPlugin implements FlutterPlugin, VideoPlayerApi {
  private static final String TAG = "CachedVideoPlayerPlugin";
  ...
  private static final class FlutterState {
    ...
    void startListening(CachedVideoPlayerPlugin plugin) {
      VideoPlayerApi.setup(binaryMessenger, plugin);
    }

    void stopListening() {
      VideoPlayerApi.setup(binaryMessenger, null);
    }
  }
}
